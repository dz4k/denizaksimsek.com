...
export default lume(
	...
	.copy('assets')
	.copy('client')
	.remoteFile("/assets/css/missing.css", "https://the.missing.style/v0.2.0/missing.min.css")
	.remoteFile("/assets/css/missing-prism.css", "https://the.missing.style/v0.2.0/missing-prism.min.css")
