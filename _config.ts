...
export default lume(
	...
	.copy('client')
	.copy('fileshare')
	.remoteFile("/assets/css/missing.css", "https://the.missing.style/v1.0.3/missing.min.css")
	.remoteFile("/assets/css/missing-prism.css", "https://the.missing.style/v1.0.3/missing-prism.min.css")
